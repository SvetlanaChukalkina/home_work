...
def main() -> None:
    ...
    if final_list == "Указанная строка не найдена" or len(final_list) == 0:
        print("Банковских операций с указанными параметрами не найдено.")
    #
    else:
        ...
        for fi in final_list:
            ...
            if mask_sender != []:
                print(
                    f"""{formatted_date}  {operation_name},
